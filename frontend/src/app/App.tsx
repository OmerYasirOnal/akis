...
/** EN/TR language toggle — shared by the authed header AND the pre-auth frame (so a visitor
 *  can switch locale before signing in). The globe glyph + aria-label make it legible as a
 *  language control; the label shows the current locale. */
...
/** Cosmic frame for the public auth pages. A low-emphasis language toggle sits top-right so a
 *  visitor can switch EN/TR before authenticating (a full TR catalog ships). */
